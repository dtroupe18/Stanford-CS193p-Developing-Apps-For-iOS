...
final class EmojiMemoryGame: ObservableObject {
    ...
    // @Published is a property wrapper that calles ObjectWillChange.send() whenever,
    // this model is mutated. 
    ...
    static func createMemoryGame() -> MemoryGame<String> {
        ...
        return MemoryGame<String>(numberOfPairsOfCards: Int.random(in: 2...5)) { pairIndex in
            ...
            let index = emojis.firstIndex(of: randomEmoji)! // This can't be nil since we took it from the collection.
